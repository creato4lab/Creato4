              ...
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent && !parent.querySelector(".fallback-icon")) {
                    ...
                    fallback.className = "fallback-icon absolute inset-0 bg-[#FAF8F5] flex flex-col items-center justify-center p-2 text-center text-[#1A3C2F]/40";
                    fallback.innerHTML = `<svg class="w-8 h-8 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg><span class="text-[9px] font-mono line-clamp-2 leading-tight">Image not found</span>`;
