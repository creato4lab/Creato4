...
export const STUDENT_PROJECTS: StudentProject[] = [
  // HARDWARE PROJECTS
  {
    id: 'smart-ambient-tv-lighting',
    title: 'Smart Ambient TV Lighting System Using ESP32',
    category: 'Hardware',
    difficulty: 'Intermediate',
    price: '$95',
    image: 'https://images.unsplash.com/photo-1593784991095-a205069470b6?auto=format&fit=crop&w=600&q=80',
    description: 'Immersive TV reactive LED backlight system built with ESP32, WS2812B addressable RGB strip, real-time HDMI/screen color sampling, and custom web app control.',
    techStack: ['ESP32', 'WS2812B LED', 'C++', 'WebSockets', 'Python Screen Sampler'],
    includes: ['Custom Power & LED Driver PCB', '3D Printed Enclosure STL Files', 'ESP32 Firmware Source Code', 'Screen Sampling Desktop App'],
    specifications: {
      'Microcontroller': 'ESP32 Dual-Core',
      'LED Type': 'WS2812B 60 LEDs/m',
      'Power Input': '5V 10A DC Power Supply',
      'Latency': '<15ms Real-Time Sync',
    },
  },
  {
    id: 'smart-dice-electronic',
    title: 'SMART Dice — Interactive Electronic Dice System',
    category: 'Hardware',
    difficulty: 'Beginner',
    price: '$45',
    image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80',
    description: 'Pocket-sized electronic dice system featuring 7-segment LED display, MPU6050 shake detection sensor, sound feedback, and low-power sleep modes.',
    techStack: ['ATtiny85 / ESP32', 'MPU6050 Accelerometer', '7-Segment Display', 'KiCAD PCB'],
    includes: ['Gerber Files & KiCAD Schematics', 'Coin-Cell Powered Mini PCB Blueprint', 'Firmware C Code', 'Assembly Manual'],
    specifications: {
      'Processor': 'ATtiny85 / Microcontroller',
      'Sensor': 'MPU6050 Motion Accelerometer',
      'Display': '0.36" LED 7-Segment',
      'Battery': 'CR2032 Coin Cell (6 months standby)',
    },
  },
