...
export const STUDENT_PROJECTS: StudentProject[] = [
  ...
  },
  {
    ...
    description: 'Full-stack WebSockets data platform for monitoring live sensor streams, alerts, and historical telemetry data.',
    techStack: ['React', 'Node.js', 'MQTT', 'WebSockets', 'Chart.js'],
    includes: ['Full React Source Code', 'Express Backend API', 'MQTT Broker Config', 'Database Setup Script'],
    specifications: {
      'Data Protocol': 'MQTT over WebSockets',
      'Database': 'TimescaleDB / PostgreSQL',
      'Frontend': 'React + TypeScript + Tailwind',
      'Latency': 'Sub-100ms Live Telemetry',
    },
  },
  {
    id: 'ai-vision-pipeline',
    title: 'Edge-AI Object Detection & Computer Vision Pipeline',
    category: 'Software',
    difficulty: 'Advanced',
    price: '$135',
    image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80',
    description: 'Real-time OpenCV and TensorFlow Lite Python computer vision system for industrial defect detection and camera tracking.',
    techStack: ['Python', 'OpenCV', 'TensorFlow Lite', 'YOLOv8'],
    includes: ['Pre-Trained Model Weights', 'Python Video Stream Script', 'Annotation Pipeline', 'Deployment Guide'],
    specifications: {
      'Framework': 'OpenCV 4 + TensorFlow Lite',
      'Inference Speed': '45 FPS on Raspberry Pi 4 / PC',
      'Model Accuracy': '96.4% mAP',
      'Input Source': 'USB Webcams / RTSP Streams',
    },
  },
  {
    id: 'cloud-api-gateway',
    title: 'Microservices API Gateway & Smart Customer Portal',
    category: 'Software',
    difficulty: 'Intermediate',
    price: '$110',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80',
    description: 'Scalable REST & GraphQL API backend with JWT authentication, role-based access control, and user management.',
    techStack: ['TypeScript', 'Express', 'GraphQL', 'Prisma ORM', 'Docker'],
    includes: ['Complete Microservice Code', 'Docker Compose Config', 'Swagger API Specs', 'CI/CD Workflow'],
    specifications: {
      'Architecture': 'Modular Microservices',
      'Auth Method': 'JWT + Refresh Tokens',
      'ORM Layer': 'Prisma + PostgreSQL',
