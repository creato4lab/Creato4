        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://images.unsplash.com https://lh3.googleusercontent.com https://*.google-analytics.com https://*.googletagmanager.com https://*.r2.cloudflarestorage.com",
              "connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://www.clarity.ms https://api.razorpay.com https://*.razorpay.com https://*.r2.cloudflarestorage.com",
              "media-src 'self' blob: data: https://*.r2.cloudflarestorage.com",
              "frame-src 'self' https://api.razorpay.com https://*.razorpay.com https://www.googletagmanager.com https://www.youtube.com https://*.youtube.com https://player.vimeo.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
